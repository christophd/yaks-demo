Feature: Food Market REST API
  ...
  Scenario: Booking and matching supply
    ...
    Given HTTP request body: {"client": "client_http", "product": "Orange", "amount": 10, "price": 1.59}
    ...
    Given HTTP request body: {"supplier": "supplier_http", "product": "Orange", "amount": 10, "price": 1.49}
    And HTTP request header Content-Type="application/json"
